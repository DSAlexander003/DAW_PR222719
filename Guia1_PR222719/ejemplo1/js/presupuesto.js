function init(){
    ...
    html += "\t\t\tEl presupuesto asginado para ginecologia es: $ " + derma + "\n";
    html += "\t\t</a>\n";
    html += "\t</li>\n";
    
    html += "\t<li>/n";
    html += "\t\t<a href='#' class='move-right'>\n";
    html += "\t\tEl presupuesto asginado para Traumatologia es: $ " + trau + "\n";
    html += "\t\t</a>\n";
    html += "\t</li>\n";

    html += "\t<li>/n";
    html += "\t\t<a href='#' class='move-right'>\n";
    html += "\t\tEl presupuesto asginado para Pediatria es: $ " + pedi + "\n";
    html += "\t\t</a>\n";
    html += "\t</li>\n";
